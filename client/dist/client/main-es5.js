...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function node_modulesRawLoaderDistCjsJsSrcAppAppComponentHtml(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "<div class=\"global-wrapper\">\n  <app-header class=\"header\"></app-header>\n  <app-content class=\"content\"></app-content>\n</div>\n";
    /***/
  },
  ...
  function node_modulesRawLoaderDistCjsJsSrcAppHeaderHeaderComponentHtml(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "<h1>Photo Board</h1>\n<div class=\"loader\" *ngIf=\"isLoading\">\n  <div class=\"lds-ring\">\n    <div></div>\n    <div></div>\n    <div></div>\n    <div></div>\n    <div></div>\n    <div></div>\n    <div></div>\n  </div>\n  <h3>Loading..</h3>\n</div>\n";
    /***/
  },
  ...
  function srcAppContentContentComponentScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = ".topbar {\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  padding-bottom: 30px;\n}\n.topbar .add-image-section form {\n  display: flex;\n}\n.topbar .add-image-section .input {\n  position: relative;\n}\n.topbar .add-image-section .input input {\n  width: 250px;\n}\n.topbar .add-image-section .input span {\n  position: absolute;\n  top: -15px;\n  left: 7px;\n  font-size: 11px;\n  font-weight: 300;\n  color: #7f7f7f;\n}\n.topbar .add-image-section .add-btn {\n  width: 70px;\n  margin-left: 15px;\n}\n.topbar .tagging-section button {\n  padding: 5px 12px;\n}\n.topbar .change-board-section {\n  display: flex;\n  position: relative;\n}\n.topbar .change-board-section .select {\n  position: relative;\n}\n.topbar .change-board-section .select select {\n  width: 140px;\n}\n.topbar .change-board-section .select span {\n  position: absolute;\n  top: -15px;\n  left: 7px;\n  font-size: 11px;\n  font-weight: 300;\n  color: #7f7f7f;\n}\n.topbar .change-board-section .new-border-btn {\n  margin-left: 40px;\n}\n.topbar .change-board-section .inputNewBoard {\n  display: flex;\n  position: absolute;\n  bottom: -65px;\n  right: 0;\n  padding: 13px;\n  border: 1px solid #e0e0e0;\n  border-radius: 6px;\n  background: #f3f3f3;\n}\n.topbar .change-board-section .inputNewBoard input {\n  border-bottom-right-radius: 0;\n  border-top-right-radius: 0;\n}\n.topbar .change-board-section .inputNewBoard .add-btn {\n  border-top-left-radius: 0;\n  border-bottom-left-radius: 0;\n  margin-right: 5px;\n}\n.images {\n  display: flex;\n  flex-wrap: wrap;\n  margin-bottom: 30px;\n  position: relative;\n}\n.images .image {\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  margin: 20px 10px;\n}\n.images .image .img-block {\n  display: inline;\n  position: relative;\n  width: auto;\n}\n.images .image .img-block img {\n  max-height: 160px;\n  box-shadow: 20px 20px 80px 0 rgba(16, 5, 48, 0.18);\n}\n.images .image-tags {\n  display: inline-flex;\n  position: absolute;\n  bottom: -20px;\n  left: 0;\n  max-width: 100%;\n  flex-wrap: wrap;\n}\n.images .image-tags span {\n  font-size: 10px;\n  color: #7f7f7f;\n  margin-right: 4px;\n  visibility: hidden;\n  cursor: pointer;\n  padding: 1px 2px;\n  background: #fff;\n  border-radius: 2px;\n  margin-bottom: 3px;\n}\n.images .image-tags span:nth-child(1), .images .image-tags span:nth-child(2) {\n  visibility: visible;\n}\n.images .image-tags:hover span {\n  visibility: visible;\n  background-color: #fff;\n  z-index: 2;\n}\n.actions {\n  display: flex;\n  justify-content: flex-end;\n  padding-bottom: 20px;\n}\n.actions .cancel {\n  margin-right: 10px;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  function srcAppContentContentComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _shared_api_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ../shared/api.service */
    "./src/app/shared/api.service.ts");

    var ContentComponent = /*#__PURE__*/function () {
      function ContentComponent(ApiService) {
      ...
      _createClass(ContentComponent, [{
        key: "addNewPhoto",
        value: function addNewPhoto() {
          var _this = this;

          if (!this.newPhotoUrl.value.text.length) return;
          this.ApiService.sendNewImage(this.newPhotoUrl.value.text, this.selectedBoard).subscribe(function (res) {
            _this.ApiService.getBoardImage(_this.selectedBoard).subscribe(function (res) {
              return _this.images = res.data;
            });
          });
        ...
        key: "runTagging",
        value: function runTagging() {
          var _this2 = this;

          this.ApiService.isLoading.next(true);
          this.ApiService.getTags(this.selectedBoard).subscribe(function (res) {
            _this2.ApiService.isLoading.next(false);
        ...
        value: function cancel() {
          ...
          this.ApiService.isLoading.next(true);
          this.ApiService.removeTags(this.selectedBoard).subscribe(function (res) {
            _this3.ApiService.isLoading.next(false);
        ...
        key: "changeBoard",
        value: function changeBoard(id) {
          var _this4 = this;

          console.log(id);
          this.ApiService.showTheBoard(id).subscribe(function (res) {
            _this4.selectedBoard = res.data.name;
            _this4.images = res.data.images;
          });
        }
      }, {
        key: "openPopup",
        ...
        value: function createNewBoard() {
          ...
          if (this.newBoardTitle.value.text.length) {
            this.isCreateNewBoardOpen = false;
            this.ApiService.createNewBoard(this.newBoardTitle.value.text).subscribe(function (resp) {
              _this5.ApiService.getAllBoards().subscribe(function (res) {
                _this5.boards = res.data;

                _this5.changeBoard(res.data[0]._id);
              });
            });
        ...
        value: function ngOnInit() {
          ...
          this.ApiService.getBoardImage("default").subscribe(function (res) {
            return _this6.images = res.data;
          });
          ...
          this.ApiService.isLoading.subscribe(function (isLoading) {
            return _this6.isLoading = isLoading;
          });
          this.ApiService.getAllBoards().subscribe(function (res) {
            return _this6.boards = res.data;
          });
        }
      }]);
  ...
  function srcAppSharedApiServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ApiService = /*#__PURE__*/function () {
      ...
      _createClass(ApiService, [{
        ...
        key: "sendNewImage",
        value: function sendNewImage(imageUrl) {
          var board = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "default";
          var obj = {
            imageUrl: imageUrl,
            board: board,
            tags: []
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /home/developer/projects/MEAN-test/client/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
